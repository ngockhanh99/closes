                            ...
                            <tr style="text-align: center">
                                <td id="logo" width="100" valign="top">
                                    <img border="0" style="margin: 0 auto"
                                         src="http://14.162.144.117/parindex/apps/cores/images/logo-SonLa.png"
                                         width="60px" height="60px"/>
                                </td>
                                <td>
                                    <h1 style="text-align: right; margin-right: 62.5px; color: #ffffff">PAR INDEX</h1>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tr>
                                            <td class="w560" width="560">
                                                <div class="article-content" align="center">
                                                    <h1 style="text-align: center">Yêu cầu duyệt kết quả đánh giá</h1>
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                                        ...
                                        <tr>
                                            <td class="w560" width="560">
                                                <div class="article-content" align="left">
                                                    <h4 class="secondary"
                                                        style="text-indent: 30px; margin-left: 30px; margin-right: 30px">
                                                        Yêu cầu các đơn vị duyệt kết quả đánh giá cho đợt đánh
                                                        giá năm 2019.
                            ...
                            <tr style="text-align: center">
                                <td style="text-align: center;border-radius:4px;">
                                    <a href="{{$data['url']}}"
                                       ...
                                       target="_blank">Duyệt kết quả đánh giá
                                    </a>
                                </td>
                            </tr>
                            <tr>
