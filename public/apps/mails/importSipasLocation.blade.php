                        ...
                        <table class="w640" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td class="w560" width="560">
                                                <div class="article-content" align="center">
                                                    <h1 style="text-align: center">Cảnh báo vị trí nhập phiếu khảo sát sai</h1>
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                                                ...
                                                <div class="article-content" align="left">
                                                    <h4 class="secondary"
                                                        ...
                                                        nhập lúc <i>{{date('d-m-Y h:i', strtotime($data['questionFormInfo']['created_at'])) }}</i>
                                                         cho đơn vị <b>{{$data['ouInfo']->ou_name}}</b> ở vị trí ở tọa độ:<br/>
                                                        - Vĩ độ(latitude): {{$data['questionFormInfo']['latitude']}} <br/>
                                                        - Kinh độ(longitude): {{$data['questionFormInfo']['longitude']}} <br/>
                                                        <span style="color: red;">Không thuộc phạm vi khảo sát cho đơn vị <b>{{$data['ouInfo']->ou_name}}</b>.</span>
                                                        <a href="https://www.google.com/maps/dir//<?php  echo $data['questionFormInfo']['latitude'] ?>,{{$data['questionFormInfo']['longitude']}}">
                                                            Xem vị trí nhập
                                                        </a>
                                                    </h4>
                                                </div>
                            ...
                            <tr style="text-align: center">
                                <td style="text-align: center;border-radius:4px;">
                                    <a href="<?php echo config("app.APP_URL");?>"
