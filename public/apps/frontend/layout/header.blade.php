<header class="main-header">
    <div class="container">
        <div class="div-main-header">
            <p style="margin-bottom: 0;"><i class="fa fa-facebook-square" aria-hidden="true"></i> | <i class="fa fa-instagram" aria-hidden="true"></i> |  <svg  class="zalo" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="28px" height="28px">
                                ...
                                <path fill="#000" d="M21.25,18h-8v1.5h5.321L13,26h0.026c-0.163,0.211-0.276,0.463-0.276,0.75V27h7.5	c0.276,0,0.5-0.224,0.5-0.5v-1h-5.321L21,19h-0.026c0.163-0.211,0.276-0.463,0.276-0.75V18z"/></svg></p>
    ...
    <div class="container h100">
        <div class="div-menu-header h100">
            <div class="logo text-center">
                <a href="{{asset('')}}"><img src="{{asset('apps/frontend/images/logo.png')}}" alt="" width="100px" height="100px"></a>
            </div>
            <div class="search">
                <form action="">
