...
<head>
    ...
    <!--app-angular-->
    <script src="<?php echo asset('apps/cores/views/components/sipas/questionFormKiosk/module.js') ?>"></script>
    ...
    <script src="<?php echo asset('apps/cores/views/components/media/mediaServices.js') ?>"></script>
    <script src="<?php echo asset('apps/cores/views/directives/formResultEvaluation/formResultEvaluationDirective.js') ?>"></script>
    <script src="<?php echo asset('apps/cores/views/directives/sipasResultEvaluation/sipasResultEvaluationDirective.js') ?>"></script>
    <!--End login-->
    <script src="<?php echo asset('apps/cores/views/components/sipas/questionFormKiosk/questionFormKioskCtrl.js') ?>"></script>
